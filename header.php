...
<header>
        <div class="icon-container">
          ...
          <img class="header-logo" src="<?php echo get_theme_file_uri('images/3fd0a12b635356f072776a8e341e9f1d.png'); ?>" alt="">
        ...
        <nav>
            <ul class="middle-nav-container">
                ...
                <li class="nav-item middle-nav"><a href="#" class="hover-home"><img class="hover-image-home" src="./images/home.svg" alt=""></a></li>
                <li class="nav-item middle-nav"><a href="#" class="hover-shop"><img class="hover-image-shop" src="./images/shop.svg" alt=""></a></li>
                <li class="nav-item middle-nav"><a href="#" class="hover-player"><img class="hover-image-player" src="./images/player.svg" alt=""></a></li>
