...
<header>
    ...
    <a href="#" class="hover-home">
        <img class="hover-image-home" src="<?php echo get_theme_file_uri('/images/home.svg'); ?>" alt="">
          </a>
          </li>
              </a></li>
                <li class="nav-item middle-nav"><a href="#" class="hover-shop"><img class="hover-image-shop" src="<?php echo get_theme_file_uri('/images/shop.svg'); ?>"  alt=""></a></li>
                <li class="nav-item middle-nav"><a href="#" class="hover-player"><img class="hover-image-player" src="<?php echo get_theme_file_uri('/images/player.svg'); ?>" alt=""></a></li>
